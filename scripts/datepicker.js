...
var WindowTitle ="PMT Calendar Picker";//Date Time Picker title.
...
function RenderCal()
{
	...
	vCalHeader+="<select class='"+MonthMenu+"' name=\"MonthSelector\" onchange=\"javascript:winMain.Cal.SwitchMth(this.selectedIndex);winMain.RenderCal();\">\n";
	for (i=0;i<12;i++)
	{
		if (i==Cal.Month)
	...
	//Year selector
	vCalHeader+="\n<td colspan='3' class='"+MonthYearHeader+"' style='text-align: right;'><a href=\"javascript:winMain.Cal.DecYear();winMain.RenderCal()\">&#160;&lt;&#160;</a>&#160;"+Cal.Year+"&#160;<a href=\"javascript:winMain.Cal.IncYear();winMain.RenderCal()\">&#160;&gt;&#160;</a></td>\n";	
	vCalHeader+="</tr>";
	//Calendar header shows Month and Year
	//if (ShowMonthYear)
	//	vCalHeader+="<tr><td colspan='7'><b>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</b></td></tr>\n";
	//Week day header
...
function GenCell(pValue,pHighLight,pColor)//Generate table cell with value
{
	...
	if ((pHighLight!=null)&&(pHighLight))
		...
		{PCellStr="<td "+vColor+"><a href=\"javascript:winMain.document.getElementById('"+Cal.Ctrl+"').value='"+Cal.FormatDate(PValue)+"';"+";window.close();\">"+PValue+"</a></td>";
		}
	return PCellStr;
}
