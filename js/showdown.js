...
var _DoItalicsAndBold = function(text) {
	...
	text = text.replace(/(\*\*|__)(?=\S)([^\r]*?\S[\*_]*)\1/g,
        ...
        // before we do <em>, we do a quick hack to prevent
        // italics in the middle of words like foo_bar_baz

	text = text.replace(/(\w+_\w+_\w[\w_]*)/g,
	       function (word) {
		 return word.replace(/_/g,'FOOBARUNDERSCORE');
	       }
	      );
	...
	text = text.replace(/(\*|_)(?=\S)([^\r]*?\S)\1/g,
        ...
        // put the underscores back in
        text = text.replace(/FOOBARUNDERSCORE/g,'_');
